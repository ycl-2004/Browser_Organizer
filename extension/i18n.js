...
const STRINGS = {
  en: {
    ...
    todayTaskPlaceholder: "What's the next thing to do?",
    ...
    sessionSaveAll: "Save All",
    sessionSaveSelected: (n) => `Save ${n} tabs`,
    sessionSaved: (n) => `Session saved — ${n} tabs`,
    sessionRestored: (n) => `Restored ${n} tabs`,
    sessionFallbackName: "Untitled session",
    ...
    confirmImport:
      "Importing this backup will replace your saved favorites, sections, daily planner tasks, Continue queue, hero note, profile image, theme, and language setting on this browser. Continue?",
  ...
  zh: {
    favorites: "收藏",
    favoriteSearchPlaceholder: "搜索收藏...",
    ...
    todayTaskPlaceholder: "下一件要做的事是什么？",
    todoEmpty: "还没有任务。先写下一件小事。",
    todoAdded: "任务已添加",
    todoDone: "任务已完成",
    noSavedSessions: "还没有保存的 Session。",
    sessionRestore: "恢复",
    sessionSaveAll: "全部保存",
    sessionSaveSelected: (n) => `保存 ${n} 个标签`,
    sessionSaved: (n) => `Session 已保存 · ${n} 个标签`,
    sessionRestored: (n) => `已恢复 ${n} 个标签`,
    sessionFallbackName: "未命名 Session",
    savedSessionsTitle: "已保存 Session",
    continueTitle: "继续处理",
    important: "重要",
    later: "稍后",
    open: "打开",
    ...
    confirmImport:
      "导入这个备份会替换此浏览器当前保存的收藏、分组、Daily Planner 任务、继续处理队列、Hero 文案、头像、主题和语言设置。继续吗？",
